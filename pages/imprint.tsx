  ...
  return (
    <main>
      ...
      <p>
        ...
        generally applicable laws remain unaffected by this as per §§ 8 to 10 of
        the Telemedia Act (TMG).
      </p>
      <h3 id="accountabilityforlinks">Accountability for links</h3>
      <p>
      ...
      <p>
        <em>Source:</em>{" "}
        <a href="http://www.translate-24h.de">
